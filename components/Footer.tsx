...
const Footer = () => {
  ...
  return (
    <footer className="border-t bg-background text-foreground shadow-sm">
      ...
      <div className="border-t">
        <div className="max-w-7xl mx-auto px-4 py-4 text-xs text-primary-500 flex items-center justify-between">
